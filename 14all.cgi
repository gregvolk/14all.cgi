...
$cfgfiledir = '/home/mrtg/cfg/';

#$ENV{RRD_DEFAULT_FONT} = '/opt/rrdtool/share/rrdtool/fonts/DejaVuSansMono-Roman.ttf';
$ENV{"TZ"} = "CST6CDT";
...
sub getdirwriteable($$)
{
	...
	$base = '/var/tmp/mrtgimages/';  ###GV MOD
        unless(-e $base) { `mkdir $base`; }
